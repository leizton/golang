...
#pragma textflag 7
void runtime_procyield(uint32 cnt) {
  uint32 volatile i;
...
#pragma textflag 7
void* runtime_atomicloadp(void* volatile* addr) {
  return (void*)runtime_xadd((uint32 volatile*)addr, 0);
}

#pragma textflag 7
void runtime_atomicstorep(void* volatile* addr, void* v) {
  void* old;
...
#pragma textflag 7
void runtime_atomicstore(uint32 volatile* addr, uint32 v) {
  uint32 old;
